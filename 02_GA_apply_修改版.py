...
# 读取用户上传的文件
df_returns = pd.read_csv('average_monthly_returns_2014.csv')
df_cov_matrix = pd.read_excel('covariance_matrix_2014.xlsx')
...
#update portfolio weight to excel
...
print(f"Calculated Best Sharpe Ratio: {best_sharpe_ratio}")
